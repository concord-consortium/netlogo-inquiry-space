...
to setup-data-export
  let computational-inputs [
    [ "Start height" "m" 0 1 true ]
    [ "Mass" "kg" 0.1 2 true ]
    [ "Ramp friction" "" 0 1 true ]
    [ "Floor friction" "" 0 1 true ] ]
  let representational-inputs [ ]
  let computational-outputs [
    [ "End distance" "s" 0 6 true ]
    [ "End height" "m" 0 1 true ]]
  let student-inputs [ ]
  let model-information [
    [ "ramp" "Ramp-starter.v3.nlogo" "v6x" ] ]
...
to update-run-series [x y]
  let computational-inputs    ( list start-height mass ramp-friction floor-friction )
  let representational-inputs []
  let computational-outputs   ( list x y )
  let student-inputs          []

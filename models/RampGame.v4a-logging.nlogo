...
;    set air-friction .2
  ...
  if level = 3 [
    set instructions "At this level the friction is less than before. How does this change your strategy?"
    set friction .3
    set old-friction friction
;    set air-friction .2
    set starting-position-locked? false    
    ...
    set target-max 3.5     ; each step, the target is set at random between target-max and target-min
    set target-min 1]   ; to defeat random placement of the target, set min to max. 
